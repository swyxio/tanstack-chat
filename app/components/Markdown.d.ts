...
export type Options = {
     ...
     */
    contentEditable?: boolean | null | undefined;
    /**
     * Callback function for handling changes when contentEditable is true
     */
    onChange?: (event: React.ChangeEvent<HTMLDivElement>) => void | null | undefined;
    /**
     * Callback function for handling changes when blur is done
     */
    onBlur?: (event: React.ChangeEvent<HTMLDivElement>) => void | null | undefined;
};
/**
 * Transform all URLs.
 */
